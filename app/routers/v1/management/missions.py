...
#
# ROLE_CAN_ASSIGN, OWNER_ROLES, and _eligible_executors live in
# app/services/mission_eligibility.py (a router-free leaf module) so voice
# assistant services can import them without a circular import back through
# this router package. Imported here so every other reference in this file
# keeps working unchanged.

from app.services.mission_eligibility import ROLE_CAN_ASSIGN, OWNER_ROLES, _eligible_executors
...
# OWNER_ROLES now comes from app.services.mission_eligibility (imported above).
...
# _eligible_executors now comes from app.services.mission_eligibility (imported above).
