...
export function ChangeUsernameDialog({ open, onOpenChange, currentUsername, onChanged }: Props) {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => {
      apiFetch(`/auth/check-username?username=${encodeURIComponent(trimmed)}`)
